...
alias killrobot='pkill -9 -f "[s]llidar_node"; pkill -9 -f slam_toolbox; pkill -9 -f wasd_teleop; pkill -9 -f nav2_; pkill -9 -f nav2_motor_bridge; echo "All robot processes killed."'
